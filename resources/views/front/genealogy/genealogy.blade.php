            ...
            <div class="root">
              <div class="member-view-box connector-a">
                <div class="member-image">
                  <img src="{{asset('front/images/dummy/dummy.jpg')}}" class="border-male" alt="Member" />
              ...
              <div class="member-view-box connector-b">
                <div class="member-image">
                  <img src="{{asset('front/images/dummy/dummy.jpg')}}" class="border-female"  alt="Member" />
                  <div class="member-details">
            ...
            <li>
              ...
              <a href="javascript:void(0);" class="relationship">
                <div class="married">
                  <div class="member-view-box connector-a">
                    <div class="member-image">
                      <img src="{{asset('front/images/dummy/dummy.jpg')}}" @if($genOne['gender']=="Male") class="border-male" @else class="border-female" @endif alt="Member" />
                      <div class="member-details">
                        <h3>{{$genOne['name']}}</h3>
                      </div>
                    </div>
                  ...
                  <div class="member-view-box connector-b">
                    <div class="member-image">
                      <img src="{{asset('front/images/dummy/dummy.jpg')}}" @if($genOne['partner']['gender']=="Male") class="border-male" @else class="border-female" @endif alt="Member" />
                      <div class="member-details">
                ...
                <li class="generation-2">
                  ...
                  <a href="javascript:void(0);" class="relationship">
                    <div class="married">
                      <div class="member-view-box connector-a">
                        <div class="member-image">
                          <img src="{{asset('front/images/dummy/dummy.jpg')}}" @if($genTwo['gender']=="Male") class="border-male" @else class="border-female" @endif alt="Member" />
                          <div class="member-details">
                            <h3>{{$genTwo['name']}}</h3>
                          </div>
                        </div>
                      ...
                      <div class="member-view-box connector-b">
                        <div class="member-image">
                          <img src="{{asset('front/images/dummy/dummy.jpg')}}" @if($genTwo['partner']['gender']=="Male") class="border-male" @else class="border-female" @endif alt="Member" />
                          <div class="member-details">
                      ...
                      <a href="javascript:void(0);" class="relationship">
                        @if($genThree['relationship_id']>0)
                          <div class="married">
                            <div class="member-view-box connector-a">
                              <div class="member-image">
                                <img src="{{asset('front/images/dummy/dummy.jpg')}}" @if($genThree['gender']=="Male") class="border-male" @else class="border-female" @endif alt="Member" />
                              <div class="member-details">
                                <h3>{{$genThree['name']}}</h3>
                              </div>
                            </div>
                          ...
                          <div class="member-view-box connector-b">
                            <div class="member-image">
                              <img src="{{asset('front/images/dummy/dummy.jpg')}}" @if($genThree['partner']['gender']=="Male") class="border-male" @else class="border-female" @endif alt="Member" />
                              <div class="member-details">
                        ...
                        <!-- Generation 3 -->
                        <ul id="generation-4">
                        @foreach($gen4 as $genFour)
                          @if($genFour['parent_id']==$genThree['relationship_id'])
                          <li class="generation-4">
                            <a href="javascript:void(0);" class="relationship">
                              @if($genFour['relationship_id']>0)
                                <div class="married">
                                  <div class="member-view-box connector-a">
                                    <div class="member-image">
                                      <img src="{{asset('front/images/dummy/dummy.jpg')}}" @if($genFour['gender']=="Male") class="border-male" @else class="border-female" @endif alt="Member" />
                                    <div class="member-details">
                                      <h3>{{$genFour['name']}}</h3>
                                    </div>
                                  </div>
                                ...
                                <div class="member-view-box connector-b">
                                  <div class="member-image">
                                    <img src="{{asset('front/images/dummy/dummy.jpg')}}" @if($genFour['partner']['gender']=="Male") class="border-male" @else class="border-female" @endif alt="Member" />
                                    <div class="member-details">
                                      <h3>{{$genFour['partner']['name']}}</h3>
                                    </div>
                                  </div>
                                </div>
                              </div>
